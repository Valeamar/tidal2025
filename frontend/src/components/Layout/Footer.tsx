        ...
        <div className="container mx-auto px-6 py-12">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-300 max-w-md leading-relaxed">
                Revolutionizing agricultural economics through AI-powered market analysis,
                helping farmers maximize profitability and optimize input costs.
              </p>
              <div className="flex space-x-4 mt-6">
                <a href="#" className="glass-button p-3 text-white hover:text-accent-400 transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/analyze" className="text-gray-300 hover:text-accent-400 transition-colors">
                    Price Analysis
                  </Link>
                </li>
                <li>
          ...
          <div className="border-t border-white/20 mt-8 pt-8 text-center">
            <p className="text-gray-300">
              © 2025 <span className="gradient-text font-semibold">FarmOptimizer</span>.
